          ...
          {loans.map((loan) => (
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 text-sm text-gray-400">
                <p>Total Repayment: <span className="text-white">₹{loan.totalRepayment}</span></p>
                <p>Outstanding: <span className="text-white">₹{loan.outstandingBalance}</span></p>
                <p>Applied On: <span className="text-white">{new Date(loan.createdAt).toLocaleDateString()}</span></p>
              </div>
